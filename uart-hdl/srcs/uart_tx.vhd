...
architecture Behavioral of uart_tx is
	...
	signal s_reg, s_next: unsigned(3 downto 0);			--holds s_tick count
	signal n_reg, n_next: unsigned(2 downto 0);			--holds bit count
	signal b_reg, b_next: std_logic_vector(7 downto 0);	--holds data_in
	signal tx_reg, tx_next: std_logic;					--holds output
	signal p_reg, p_next: std_logic;					--holds parity
